...
class RaidAvgHPSOverlay(BaseOverlay):
	def __init__(self):
		BaseOverlay.__init__(self, title="Raid Avg. HPS", size=(300, 150))
	...
	def OnAnalyzerTick(self, analyzer):
		...
		for player in sorted(raid.playerData, sortf):
			...
			self.grid.SetCellValue(index, 1, locale.format("%.2f", avgHps, grouping=True))

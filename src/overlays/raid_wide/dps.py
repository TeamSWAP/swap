...
class RaidDPSOverlay(BaseListOverlay):
    def __init__(self):
        BaseListOverlay.__init__(self, title="Raid DPS", size=(300, 150))
    ...
    def createUI(self):
        ...
        self.setColumns(["Player", "DPS", "ShareBar"], [1, 1, 1], [BaseListOverlay.LEFT, BaseListOverlay.LEFT, BaseListOverlay.RIGHT])
